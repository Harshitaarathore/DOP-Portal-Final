...
router.put('/:id/approve', verifyToken, allowRoles('Secretary'), checkPermission('Requests', 'approve'), approveRequest);
router.put('/:id/reject', verifyToken, allowRoles('Secretary'), checkPermission('Requests', 'approve'), rejectRequest);
router.put('/:id/reschedule', verifyToken, allowRoles('Secretary'), checkPermission('Requests', 'edit'), rescheduleRequest);
