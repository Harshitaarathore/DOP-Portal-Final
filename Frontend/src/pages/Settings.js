...
const handleTogglePermission = async (id, field, currentValue) => {
 ...
 const tabs = role === 'Director' || role === 'Secretary'
  ? [{key:'profile', label:'Profile'}, {key:'password', label:'Password'}, {key:'users', label:'Users'}, {key:'departments', label:'Departments'}, {key:'permissions', label:'Permissions'}, {key:'notifications', label:'Notifications'}, {key:'security', label:'Security'}]
