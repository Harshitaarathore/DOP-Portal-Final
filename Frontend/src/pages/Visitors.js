            ...
            <div style={S.listPanel}>
              {loading ? (
                ...
                >
                  ...
                  {v.invited_by ? (
                    <div style={{ fontSize: '9px', color: '#2563EB', marginTop: '4px', fontWeight: '600' }}>
                      👤 Invited by Staff: {v.invited_by}
                    </div>
                  ) : (
                    <div style={{ fontSize: '9px', color: '#94A3B8', marginTop: '4px', fontStyle: 'italic' }}>
                      Self-registered visitor
                    </div>
                  )}
                </div>
              ))}
              ...
              {selectedVisitor ? (
                <>
                  ...
                  {[
                    ...
                    { label: 'Invited By', value: selectedVisitor.invited_by ? `Staff: ${selectedVisitor.invited_by}` : 'Self-registered (External)' },
                  ].map((row, i) => (
