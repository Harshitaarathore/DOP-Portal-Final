      ...
      <div style={styles.main}>
        <div style={styles.topbar}>
          <div>
            ...
            <div style={styles.topbarSub}>Staff Portal</div>
          </div>
...
const styles = {
  ...
  logoutBtn:     { background:'#EF4444', color:'#fff', border:'none', borderRadius:'8px', padding:'6px 14px', fontSize:'11px', fontWeight:'600', cursor:'pointer' },
